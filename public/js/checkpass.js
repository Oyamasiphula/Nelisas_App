function validate() {
  isValid = (document.newUserCredentials.passphrase1.value == document.newUserCredentials.passphrase2.value)
    && document.newUserCredentials.passphrase1.value.length > 3;
...
//       }
//       // function validate() {
//         // isValid = (document.formname.password1.value == document.formname.password2.value) && document.formname.password1.value.length > 3;
//          // Add any additional validation here
//       // }
//   }
